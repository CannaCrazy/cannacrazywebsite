...
function cannacrazy_enqueue_assets() {
    ...
    // Theme stylesheet
    wp_enqueue_style('cannacrazy-style', get_stylesheet_uri(), array(), '1.0.0');
    
    // JavaScript files
    wp_enqueue_script('cannacrazy-cart', get_template_directory_uri() . '/js/cart.js', array(), '1.0.0', true);
    wp_enqueue_script('cannacrazy-modals', get_template_directory_uri() . '/js/modals.js', array(), '1.0.0', true);
    wp_enqueue_script('cannacrazy-budtender', get_template_directory_uri() . '/js/budtender.js', array(), '1.0.0', true);
    wp_enqueue_script('cannacrazy-effects', get_template_directory_uri() . '/js/background-effects.js', array(), '1.0.0', true);
